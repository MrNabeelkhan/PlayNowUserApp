...
class JoinCompetitionDetailDialogForSinglePlayer extends StatefulWidget {
  const JoinCompetitionDetailDialogForSinglePlayer(
      {Key? key,
  ...
  @override
  State<JoinCompetitionDetailDialogForSinglePlayer> createState() =>
      _JoinCompetitionDetailDialogForSinglePlayerState();
}

class _JoinCompetitionDetailDialogForSinglePlayerState
    extends State<JoinCompetitionDetailDialogForSinglePlayer> {
  @override
